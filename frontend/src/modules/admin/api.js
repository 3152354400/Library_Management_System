...
// ——————————————————罚款管理接口————————————————
export const getPendingFines = () => http.get('/admin/extension/fines/pending', { withToken: true })
export const payFine = (data) => http.post('/admin/extension/fines/pay', data, { withToken: true })
export const waiveFine = (data) => http.post('/admin/extension/fines/waive', data, { withToken: true })

// ——————————————————荐购处理接口————————————————
export const getPendingRecommends = () => http.get('/admin/extension/recommends/pending', { withToken: true })
export const handleRecommend = (data) => http.post('/admin/extension/recommends/handle', data, { withToken: true })
